...
def tobs():
    ...
    most_recent_date = datetime.strptime(most_recent_date, '%Y-%m-%d')  # Convert to datetime object
...
# Define the start and end date route and provide a route description.
